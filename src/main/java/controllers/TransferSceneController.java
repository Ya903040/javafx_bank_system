...
public class TransferSceneController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resources) {
        ...
        labelUsed = true;
        upGreenArrow = new ImageView(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/upGreenArrow.png"))));
        downGreenArrow = new ImageView(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/downGreenArrow.png"))));
